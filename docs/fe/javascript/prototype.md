...
// 对象实例
const person1 = new Person('hualess')
console.log(person1) // Person {name: 'hualess'}
```
...
console.log(person1.name, person2.name) // 'hualess' 'hualess'
```
...
// 对象实例
const person = new Person('hualess')
