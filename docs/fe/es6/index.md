...
log('hualess', 1, 2) // hualess [1, 2]
log('hualess', 1, 2, 3) // hualess [1, 2, 3]
```
...
// 字符串会以字符数组的形式做合并
Object.assign({}, 'hualess') // {0: 'm', 1: 'a', 2: 'o', 3: 'm', 4: 'a', 5: 'o'}
...
```js
const obj = { name: 'hualess', age: 18 }
Object.keys(obj) // ['name', 'age']
Object.values(obj) //  ['hualess', 18]
Object.entries(obj) // [['name', 'hualess'], ['age', 18]]
```
...
```js
Object.fromEntries([['name', 'hualess']]) // {name: 'hualess'}

/* Map 转对象 */
const map = new Map([['name', 'hualess']])
Object.fromEntries(map) // {name: 'hualess'}

/* 将查询字符串转为对象 */
const params = 'name=hualess&age=18'
Object.fromEntries(new URLSearchParams(params)) // {name: 'hualess', age: '18'}
```
...
[Promise 实现](https://github.com/hualess1996/Promise) 简易实现、A+ 规范实现、原型方法、静态方法实现
