...
// 任意类型
const anyArray: Array<any> = ['hualess', 18, {}]
```
...
```ts
const tuple: [string, number] = ['hualess', 18]
...
```ts
type Name = 'hualess' | 'hualess1996' | '驾狗师'
```
